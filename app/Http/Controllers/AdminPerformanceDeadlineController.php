...
class AdminPerformanceDeadlineController extends Controller
{
    //
    ...
    return view('pages.admin_performance_deadline',compact('roles','admin'),array('user'=> Auth::user()));
    }
...
public function search(Request $r)
      ...
      public function editStatus(Request $r)
    {
        ...
        return view('pages.admin_performance_deadline',compact('ra'));
    }
