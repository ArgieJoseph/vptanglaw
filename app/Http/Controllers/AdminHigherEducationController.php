...
class AdminHigherEducationController extends Controller
{
    //
 //
    /**
    ...
    public function index(Request $request)
    {
         ...
         $offered= DB::table('t_universities')
            ...
            if ($request->ajax()) {
           return view('tables.admin_higher_table', compact('offered'));
        }

           //return view('pages.admin_campus',compact('univs'));   
        return view('pages.admin_program_higher',compact('univs','offered'),array('user'=> Auth::user()));
 //return view('pages.admin_campus',['categorys'=>Category::pluck('name','id')],array('user'=> Auth::user()));
    ...
    public function create(Request $r)
    {
        ...
        if ($r->ajax())
        {
            ...
            $t_u['sy_id'] = $a_sy;
            $t_u['sem_id'] = $a_sem;
            $t_u['education'] ='Higher Education'; 
            $t_u['major'] = $r->major;
            $t_u['course'] = $r->course;
