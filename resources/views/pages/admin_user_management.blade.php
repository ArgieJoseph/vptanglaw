      ...
      <!-- page content -->
          <div class="">
                     ...
                     <div id="laman">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input placeholder="Argie Joseph" type="text" value="{{old('fname')}}" id="fname"  name="fname" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input placeholder="Bigornia" type="text" id="lname" name="lname" value="{{old('lname')}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Middle Name</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="mname" class="form-control col-md-7 col-xs-12" type="text" name="mname" value="{{old('mname')}}" placeholder="Diaz">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input placeholder="arjbigornia23@gmail.com" id="email" value="{{old('email')}}" name="email" class="form-control col-md-7 col-xs-12" required="required" type="text">
                        </div>
                      </div>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input placeholder="******" id="inputPassword" name="password" class="form-control col-md-7 col-xs-12" type="password">
                        </div>
                      </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      ...
                      @include('tables.admin_user_table')
