            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-laptop"></i> Performance Appraisal <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('admin_points')}}">Report Weight</a></li>
                      <li><a href="{{route('admin_deadline')}}">Publishing Deadline</a></li>
                    </ul>
                  </li>
