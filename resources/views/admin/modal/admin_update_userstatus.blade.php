    <div class="modal fade" id="editStatus" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-sm">
                                 ...
                                 {!!Form::open(['url'=>'updateUserStatus','method'=>'POST','id'=>'user-updatestatus'])!!}
                                  {!!Form::hidden('status',null,['id'=>'status','class'=>'form-control'])!!}
                    
                      {!!Form::hidden('id',null,['id'=>'id'])!!}
                                 {!!Form::hidden('uid',null,['id'=>'uid'])!!}

            
<div class="col-md-12">
                     
                        <div class="form-group">
                        <label class="control-label">Are you sure to change the status?</label>
                        </div>
